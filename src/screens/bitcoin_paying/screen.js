...
class PaypalPaying extends React.Component {
  ...
  render() {
    const {invoice, timer, showAlert, openQRModal} = this.state
              ...
              <Card className="bg-white p-0 detail pt-3">
                ...
                <div className="top p-4 pt-5">
                  <div className="d-flex justify-content-between align-items-center ">
                    ...
                    <span className="badge text-primary bold status" id="status">{this.setInvoiceStatus(invoice.status || 0)}</span>
                  </div>
