								...
								is_authed ?
									<DropdownMenu right className="mt-2">
										...
										<DropdownItem className={isShop ? 'active' : ''}
											...
											<i className={isShop ? "far fa-dot-circle fa-md" : "far fa-circle fa-md"}/> Your
											Shop
										...
										<DropdownItem onClick={() => this.signOut()}>
											<i className={path.startsWith('/signin') ? "far fa-dot-circle fa-md" : "far fa-circle fa-md"}/> Sign
											Out
										</DropdownItem>
									</DropdownMenu> :
									<DropdownMenu right className="mt-2">
